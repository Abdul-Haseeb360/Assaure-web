    ...
    <section className="">
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-start mb-6 pt-[120px]">
          ...
          <Link
            href="#"
            className="mt-4 md:mt-0 text-secondary-gray font-montserrat font-medium text-baseborder-b-2 border-transparent hover:border-b-2 transition-colors duration-700 hover:border-primary-green pb-1"
          >
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="bg-white rounded-md overflow-hidden">
            ...
            <div className="pt-4">
              ...
              <Link
                href="#"
                className="text-secondary-gray font-montserrat text-baseborder-b-2 border-transparent hover:border-b-2 transition-colors duration-700 hover:border-primary-green pb-1 text-base font-medium inline-block"
              >
                View
              </Link>
            </div>
          ...
          <div className="space-y-6 pb-[86px]">
            {newsItems.map((item, index) => (
              ...
              >
                ...
                <Link
                  href={item.link}
                  className="text-gray-800 border-b-2 border-transparent hover:border-b-2 hover:border-primary-green transition-colors duration-300 pb-1 font-medium inline-block"
                >
                  Read news
                </Link>
              </div>
